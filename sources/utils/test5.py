...
def get_features(path):
    ...
    df = df.drop(['Date first seen', 'Duration', 'Proto', 'Flows', 'Tos', 'Src Pt', 'Dst Pt', 'Packets', 'Src IP Addr',
                  'Dst IP Addr', 'Bytes', 'Flags','attackType',	'attackID',	'attackDescription', 'newBytes', 'norm_newBytes'], axis=1)
...
def do_cnn_lstm(trainX, testX, trainY, testY):
    ...
    inputs = Input(shape=(32,1), name='input')
    ...
    full_connection = Dense(32, activation='relu')(cnn_network)
